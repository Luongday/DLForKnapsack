...
def main() -> None:
    ...
    all_solvers = ["dp", "greedy", "ga", "gnn", "dqn"]
    if args.only:
    ...
    # 4. GNN
    if "gnn" in solvers:
        model_path = args.model_path or (results_dir / "GNN" / "gnn.pt")
    ...
    # 5. DQN
    if "dqn" in solvers:
        dqn_model = args.dqn_model or (results_dir / "DQN" / "dqn.pt")
